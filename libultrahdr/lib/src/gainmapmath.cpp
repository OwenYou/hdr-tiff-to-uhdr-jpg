...
// MODIFIED (see project NOTICE.md): replaced IEC 61966-2-1 piecewise curve
// with pure power-2.2 to match the SDR gamma encoding used by this pipeline.
float srgbInvOetf(float e_gamma) { return std::pow(e_gamma, 2.2f); }
...
// MODIFIED (see project NOTICE.md): replaced IEC 61966-2-1 piecewise curve
// with pure power-2.2 to match the SDR gamma encoding used by this pipeline.
float srgbOetf(float e) { return std::pow(e, 1.0f / 2.2f); }
